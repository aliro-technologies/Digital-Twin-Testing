...
class StartKeyManagementReply(object):
    """
    Attributes:
     - status
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('StartKeyManagementReply')
...
class StopKeyManagementReply(object):
    """
    Attributes:
     - status
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('StopKeyManagementReply')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.I16, 1)
            oprot.writeI16(self.status)
            oprot.writeFieldEnd()
...
class AcquireKeyReply(object):
    ...
    def __init__(self, status=None, keyId=None, key=None,):
        self.status = status
        self.keyId = keyId
        self.key = key
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('AcquireKeyReply')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.I16, 1)
            oprot.writeI16(self.status)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(StartKeyManagementReply)
StartKeyManagementReply.thrift_spec = (
    None,  # 0
    (1, TType.I16, 'status', None, None, ),  # 1
)
all_structs.append(StopKeyManagementReply)
StopKeyManagementReply.thrift_spec = (
    None,  # 0
    (1, TType.I16, 'status', None, None, ),  # 1
)
all_structs.append(AcquireKeyReply)
AcquireKeyReply.thrift_spec = (
    None,  # 0
    (1, TType.I16, 'status', None, None, ),  # 1
